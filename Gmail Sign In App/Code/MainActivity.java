...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions googleSignInOptions=new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN).requestIdToken("594173868225-kblsc2mr4nrblfvqv0k8nps1muicm9q2.apps.googleusercontent.com").requestEmail().build();
